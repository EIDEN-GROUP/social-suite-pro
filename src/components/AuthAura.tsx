...
/**
 * Living-gradient aurora backdrop for the auth surfaces. Three blurred,
 * slowly-drifting colour orbs + a film grain make a frosted glass card
 * read like a specimen floating on coloured paper. Pass `accent` (a hex
 * colour) to tint the lead orb to a client's brand on the workspace login.
 */
