...
import { N as NodeResponse, t as toNodeHandler } from "./_libs/srvx.mjs";
...
const _lazy_nNgxXF = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_nNgxXF };
  return ((_m, p) => {
