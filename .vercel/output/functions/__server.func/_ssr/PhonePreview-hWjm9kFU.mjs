            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-y-auto bg-background pb-2 text-foreground", style: { paddingTop: "40px" }, children }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-3 z-20 h-[30px] w-[100px] -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto h-full w-[88px] rounded-full bg-black shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full items-center justify-end gap-1 px-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-orange-400/80" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-4 rounded-full bg-neutral-700" })
                    ] }) }) })
                  ]
                }
              )
