...
import { R as Route$3 } from "./router-X9M_U4_f.mjs";
import "../_libs/seroval.mjs";
import { L as Lock, A as ArrowRight, f as ChevronDown, g as SquarePlus, T as TextAlignJustify, G as Grid3x3, F as Film, U as UserCheck, h as Play, I as Images, i as House, j as Search, M as MessageCircle, R as Repeat2, H as Heart, E as Ellipsis, k as ThumbsUp, d as Send, X, l as ChevronLeft, m as ChevronRight } from "../_libs/lucide-react.mjs";
...
function ClientRoom() {
  ...
  if (!authed || !company) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthAura, { accent, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-rise w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-card rounded-[2rem] border border-white/40 p-8 sm:p-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-12 w-12 shrink-0 place-items-center overflow-hidden rounded-2xl text-base font-bold text-white shadow-lg", style: {
            background: accent || "#0d0d0d"
          }, children: logo ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "", className: "h-full w-full object-cover" }) : (brandName || slug).slice(0, 2).toUpperCase() }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-7 font-display text-5xl leading-[0.95]", children: [
          "Your work,",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, className: "mt-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "password", autoFocus: true, value: pw, onChange: (e) => setPw(e.target.value), placeholder: "••••••••", className: "w-full rounded-xl border border-foreground/10 bg-background/50 py-3 pl-11 pr-4 text-base outline-none transition focus:border-foreground/40 focus:bg-background/80 focus:ring-4 focus:ring-foreground/5" })
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-center text-[11px] text-muted-foreground", children: "Reviewed in seconds — no account needed. Powered by Atelier." })
    ] }) });
  }
